...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00, PINC: 0x00 => PORTD: 0x00',
	...
	{'description': 'PINA: 0x51, PINB: 0x02, PINC: 0x01 => PORTD: 0x00',
        'steps': [ {'inputs': [('PINA',0x51),('PINB',0x02),('PINC',0x01)], 'iterations': 5 } ],
        'expected': [('PORTD',0x14)],
        },
        {'description': 'PINA: 0xFF, PINB: 0x01, PINC: 0x01 => PORTD: 0x00',
        'steps': [ {'inputs': [('PINA',0xFF),('PINB',0x01),('PINC',0x01)], 'iterations': 5 } ],
        'expected': [('PORTD',0x43)],
        },
        ]
#watch = ['PORTD']
